...
% step 1: read image
input = imread('tank1_shrunk_shrunk.jpg');
I = rgb2gray(input);
...
%fudge factor used for sensitivity threshold, can play around with this to
%determine
fudgeFactor = 0.5;
...
%use this if choose to not carry out steps 5 and 6 
% BW_outline = bwperim(BW_fill);
BW_outline = bwperim(BW_final);
Segout = I; 
%set outline to 0 to be black
Segout(BW_outline) = 0; 
